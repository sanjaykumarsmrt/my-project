    ...
    >
      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div
          data-aos="fade-left"
          data-aos-delay="400"
          className="lg:flex-grow md:w-1/2 lg:pl-8 flex flex-col md:items-start md:text-left items-center text-center"
        >
          ...
          <p className="mb-8 text-white leading-relaxed">
            ...
            veniam iure aliquam quod libero praesentium reprehenderit asperiores
            ipsam. Ut deleniti quia et libero quisquam, velit consequuntur
            ratione dolorem repellendus mollitia odit facere enim nam voluptas
            molestias adipisci est. Quaerat, architecto ipsum eligendi
            dignissimos earum at eos! Non, ipsum eum!
          </p>
          <h2 className="title-font font-bold text-white sm:text-2xl">2023</h2>
          <p className="mb-8 text-white leading-relaxed">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. At, nulla
