            ...
            <div className="py-8 lg:py-16 mx-auto max-w-screen-md">
                ...
                <form action="#" className="space-y-8">
                    <div>
                        ...
                        type="Email"
                        id="email" 
                        className="shadow-sm bg-gray-300 font-bold border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-primary-500 block w-full p-2.5" placeholder="name@gmail.com" required/>
                    </div>
                    <div className="sm:col-span-2">
                        ...
                        rows="6" 
                        id="message" 
                        className="shadow-sm bg-gray-300 font-bold border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-primary-500 block w-full p-2.5" placeholder="Leave a comment" required/>
                    </div>
