        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center relative">
            <img
              ...
              data-aos-delay="400"
              alt="hi-img"
              className="absolute top-[250px] left-52 md:top-[-120px] md:left-[490px] transform -translate-x-1/2 -translate-y-1/2 w-20 h-20"
            />
            <h1 className="title-font sm:text-4xl text-4xl mb-4 font-bold text-white">
              Hi! I'm SANJAY KUMAR
            </h1>
            <p className="mb-8  leading-relaxed">I am a Fullstack Developer</p>
